describe("Should open the first document of a track and see it in the Viewer", () => {
  it(
    "navigate to Documents page and open a file",
    { viewportWidth: 1200 },
    () => {
      cy.visit("/");
      ...
      cy.get('[data-testid="trackfilter-clear"]', { timeout: 6000 }).click();
